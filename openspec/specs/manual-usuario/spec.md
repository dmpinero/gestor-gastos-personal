...
### Requisito: Tours de las páginas de Backup
...
### Requisito: Tour de Asociar conceptos dentro de Gestión

El tour de Asociar conceptos (antes "Gestión de conceptos", ahora sub-página
de Gestión) DEBE recorrer el formulario de asociación por categoría, el de
asociación por descripción, el botón de crear asociación, y las tablas de
asociaciones ya creadas. El paso de orientación DEBE resaltar la sección
"Gestión" del menú lateral.

#### Escenario: El tour de Asociar conceptos recorre sus formularios y tablas
...
### Requisito: Acceso directo a Asociar conceptos desde Resumen anual
...
#### Escenario: El tour de Resumen anual incluye el acceso a Asociar conceptos
...
### Requisito: Movimientos como sección de menú independiente
...
#### Escenario: Movimientos aparece como sección propia bajo Dashboard
...
### Requisito: Backup como sección renombrada
...
#### Escenario: Backup es la última sección, con Gestión justo encima

- Dado que la persona usuaria abre el menú lateral
- Cuando observa el orden de las secciones
- Entonces "Backup" es la última sección y "Gestión" es la sección inmediatamente anterior a ella

### Requisito: Agrupación visual del menú lateral
...
#### Escenario: El menú lateral muestra dos grupos etiquetados
